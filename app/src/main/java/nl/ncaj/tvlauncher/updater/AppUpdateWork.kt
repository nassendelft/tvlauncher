...
class AppUpdateWork @AssistedInject constructor(
  ...
  companion object {
    const val KEY_HAS_UPDATE = "nl.ncaj.tvlauncher.updater.KEY_HAS_UPDATE"
    const val KEY_URI = "nl.ncaj.tvlauncher.updater.KEY_URI"
    const val KEY_VERSION = "nl.ncaj.tvlauncher.updater.KEY_VERSION"
    const val KEY_DATE = "nl.ncaj.tvlauncher.updater.KEY_DATE"
    const val KEY_ERROR = "nl.ncaj.tvlauncher.updater.KEY_ERROR"
  }
}
